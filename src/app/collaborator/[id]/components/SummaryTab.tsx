        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <div className="grid grid-cols-3 gap-x-4 gap-y-3 text-sm items-center">
            ...
            <label className="font-medium">
              Monto de remuneración básica inicial:
            </label>
        ...
        <div className="bg-white rounded-lg shadow p-4 text-sm">
          ...
          <div className="mt-3 border-t border-gray-200 pt-3">
            ...
            <div className="flex gap-6 items-center">
              ...
              <label className="flex items-center gap-1">
                <input type="radio" name="discapacidad" defaultChecked />{" "}
                <span>No</span>
              </label>
            </div>
          </div>
          ...
          <div className="mt-3">
            ...
            <div className="flex gap-6 items-center">
              ...
              <label className="flex items-center gap-1">
                <input type="radio" name="sindicalizado" defaultChecked />{" "}
                <span>No</span>
              </label>
            </div>
          </div>
