...
import { MoreVertical, DollarSign, FileText, PiggyBank, BarChart3 } from 'lucide-react';
              ...
              <div className="flex items-center justify-between px-1 py-0.5 pl-2.5">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <div className={`p-1.5 rounded-full ${
                    ...
                    <proceso.icono className={`h-5 w-5 ${
                      proceso.actualizado ? 'text-blue-600' : 'text-yellow-600'
                    }`} />
                  </div>
