  ...
  return (
    <Card className="h-full bg-[#DFDFDF]">
      <CardHeader className="pb-3">
        ...
        <div className="flex gap-2 flex-wrap">
          <Button 
            ...
            className={activeChart === 'trabajadores' ? 'bg-blue-600 hover:bg-blue-700' : ''}
          >
            Trabajadores
          </Button>
          <Button 
            ...
            className={activeChart === 'gastos' ? 'bg-blue-600 hover:bg-blue-700' : ''}
          >
            Gastos
          </Button>
          <Button 
            ...
            className={activeChart === 'horas' ? 'bg-blue-600 hover:bg-blue-700' : ''}
          >
            Horas Extras
          </Button>
          <Button 
            ...
            className={activeChart === 'liquidaciones' ? 'bg-blue-600 hover:bg-blue-700' : ''}
          >
            Liquidaciones
          </Button>
        </div>
      ...
      <CardContent className="h-[calc(100%-10rem)]">
        <div className="mb-2">
          <p className="text-sm font-medium text-gray-700">{chartConfig.label}</p>
        </div>
