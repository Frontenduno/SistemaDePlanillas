    ...
    <div className="mb-6">
      <div className="flex items-center mb-3 gap-2">
        ...
        <Checkbox
          ...
          onCheckedChange={(v) => setAsignacionFamiliar(Boolean(v))}
          ...
          <div key={idx} className="grid grid-cols-4 gap-2 items-start">
            ...
            >
              <Input
                ...
                disabled={!asignacionFamiliar}
                onChange={(e) =>
                  updateFamiliar(idx, "apellidoP", e.target.value)
                }
              />
            </Field>
            <Field
            ...
            >
              <Input
                ...
                disabled={!asignacionFamiliar}
                onChange={(e) =>
                  updateFamiliar(idx, "apellidoM", e.target.value)
                }
              />
            </Field>
          </div>
        ...
        <div className="flex gap-2 mt-2">
          <div className="flex items-center">
            <Button
              ...
              size="sm"
              onClick={addFamiliar}
              className={`w-8 h-8 flex items-center justify-center text-lg leading-none rounded-md ${
                !asignacionFamiliar
                  ? "opacity-50 cursor-not-allowed bg-[#D9D9D9]"
                  : "bg-[#342ABF] hover:bg-[#2e24a8] text-white"
              }`}
              disabled={!asignacionFamiliar}
            >
              +
          ...
          <div className="flex items-center">
            <Button
              ...
              size="sm"
              onClick={() =>
                familiares.length > 1 && removeFamiliar(familiares.length - 1)
              }
              className={`w-8 h-8 flex items-center justify-center text-lg leading-none rounded-md ${
                !asignacionFamiliar || familiares.length <= 1
                  ? "opacity-50 cursor-not-allowed bg-[#D9D9D9]"
                  : "bg-[#342ABF] hover:bg-[#2e24a8] text-white"
              }`}
