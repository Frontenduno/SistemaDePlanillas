      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <Field label="Tipo de Documento" required>
          <Select
            ...
            onValueChange={(v) => onChange("tipoDocumento", v)}
          >
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <Field label="Nacionalidad" required>
          <Select
            ...
            onValueChange={(v) => onChange("nacionalidad", v)}
          >
            <SelectTrigger className="bg-white h-10">
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <Field label="Nivel Educativo" required>
          <Input
            ...
            onChange={(e) => onChange("nivelEducativo", e.target.value)}
            className="bg-white h-10"
          />
        </Field>
        <Field label="Profesión" required>
          <Select
            ...
            onValueChange={(v) => onChange("profesion", v)}
          >
            <SelectTrigger className="bg-white h-10">
