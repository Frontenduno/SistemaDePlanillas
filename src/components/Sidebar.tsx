...
export default function Sidebar({ isOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    {icon: FaCalendarCheck, label: "Ctrl. de Asistencias", href: "/asistencias/pri" },
      ...
      {isOpen && (
        ...
        >
          ...
          <div className=" flex flex-col justify-center w-full pt-4">
            <p
              className={`text-center text-5xl font-bold ${namdhinggo.className}`}
            >
              J&P
            </p>
            <p className={`text-center text-xl ${namdhinggo.className}`}>
              Perifericos
            </p>
          </div>
